...
?>
<div class="razor_contact horizontal <?php echo $mod_class_suffix; ?>">
	<form action="<?php echo $url; ?>" method="POST" enctype="multipart/form-data">
		...
		<div class="column2">
			...
			<input class="razor_contact button <?php echo $mod_class_suffix; ?>" type="submit" value="<?php echo $buttonText; ?>" style="width: <?php echo $buttonWidth; ?>%"/>
		</div>
	</form>
</div>