...
?>
<div class="rapid_contact vertical <?php echo $mod_class_suffix; ?>">
	<form action="<?php echo $url; ?>" method="POST" enctype="multipart/form-data">
		...
		<?php if ($myAditional1Active == 1) : ?>
			...
			<div class="aditional1-input">
				<input class="rapid_contact inputbox <?php echo $mod_class_suffix; ?>" type="text" name="rp_aditional1" value="<?php echo $CORRECT_ADITIONAL1; ?>"/>
			</div>
		<?php endif; ?>
		...
		<?php if ($myAditional2Active == 1) : ?>
			...
			<div class="aditional2-input">
				<input class="rapid_contact inputbox <?php echo $mod_class_suffix; ?>" type="text" name="rp_aditional2" value="<?php echo $CORRECT_ADITIONAL2; ?>"/>
			</div>
		<?php endif; ?>
		...
		<?php if ($myAditional3Active == 1) : ?>
			...
			<div class="aditional3-input">
				<input class="rapid_contact inputbox <?php echo $mod_class_suffix; ?>" type="text" name="rp_aditional3" value="<?php echo $CORRECT_ADITIONAL3; ?>"/>
			</div>
		<?php endif; ?>
		...
		<?php if ($myAditional4Active == 1) : ?>
			...
			<div class="aditional4-input">
				<input class="rapid_contact inputbox <?php echo $mod_class_suffix; ?>" type="text" name="rp_aditional4" value="<?php echo $CORRECT_ADITIONAL4; ?>"/>
			</div>
		<?php endif; ?>
		...
		<?php if ($myAditional5Active == 1) : ?>
			...
			<div class="aditional5-input">
				<input class="rapid_contact inputbox <?php echo $mod_class_suffix; ?>" type="text" name="rp_aditional5" value="<?php echo $CORRECT_ADITIONAL5; ?>"/>
			</div>
		<?php endif; ?>
		...
		<input class="rapid_contact button <?php echo $mod_class_suffix; ?>" type="submit" value="<?php echo $buttonText; ?>" />
	</form>
</div>